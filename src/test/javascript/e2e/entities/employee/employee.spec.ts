...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('gwApp.employee.home.title');
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('gwApp.employee.home.createOrEditLabel');
  ...
  it('should create and save Employees', async () => {
    ...
    await promise.all([
      ...
      employeeUpdatePage.setDateOfBirthInput('2000-12-31'),
    ]);
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('gwApp.employee.delete.question');
