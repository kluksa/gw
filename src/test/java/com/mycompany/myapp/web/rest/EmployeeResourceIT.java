...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).dateOfBirth(DEFAULT_DATE_OF_BIRTH);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.lastName(UPDATED_LAST_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH);
